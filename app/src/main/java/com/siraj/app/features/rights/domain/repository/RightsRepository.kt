...
interface RightsRepository {
    suspend fun updateAssetRights(assetId: String, updates: Map<String, Any?>): Resource<Unit>
    suspend fun logRightsDecision(assetId: String, reviewerId: String, previousStatus: RightsStatus, newStatus: RightsStatus, reason: String): Resource<Unit>
    fun getAssetsWithPendingRights(workspaceId: String): Flow<Resource<List<Asset>>>
    fun getAssetsWithExpiringRights(workspaceId: String, daysThreshold: Int = 30): Flow<Resource<List<Asset>>>
