...
import com.siraj.app.data.services.MockIdeaGeneratorServiceImpl
...
class IdeationViewModel(
    private val ideaGenerator: IdeaGeneratorService = com.siraj.app.data.services.FirebaseIdeaGeneratorServiceImpl(),
    ...
    fun convertToProject(idea: GeneratedIdea, onProjectCreated: (String) -> Unit) {
        viewModelScope.launch {
