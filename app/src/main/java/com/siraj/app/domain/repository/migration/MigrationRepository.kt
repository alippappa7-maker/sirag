...
interface MigrationRepository {
    ...
    suspend fun createMigrationJob(targetVersion: Int, collections: List<String>, isDryRun: Boolean): Resource<MigrationJob>
    ...
    suspend fun getOutdatedDocuments(collectionName: String, targetVersion: Int, limit: Int, lastDocumentId: String?): Resource<List<DocumentSchemaState>>
