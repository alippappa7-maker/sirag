...
interface ContentCorrectionRepository {
    ...
    fun getVersionByNumber(contentId: String, versionNumber: Int): Flow<ContentVersion?>
    ...
    suspend fun submitReview(noticeId: String, review: CorrectionReview): Resource<Unit>
    suspend fun updateAssetStatus(assetId: String, newStatus: AssetImpactStatus): Resource<Unit>
