 ...
 */
enum class ParentalConsentStatus(
    val titleArabic: String,
) {
 ...
 */
enum class ChildSafetyIncidentType(
    val code: String,
    val titleArabic: String,
    val defaultUrgency: IncidentUrgency,
) {
...
enum class IncidentUrgency(
    val titleArabic: String,
    val maxResponseSlaMinutes: Int,
) {
