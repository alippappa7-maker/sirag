...
interface InteractionRepository {
    ...
    // Saves
    suspend fun toggleSave(userId: String, targetId: String): Resource<Boolean>
    suspend fun getSavedItems(userId: String): Resource<List<String>>

    // Follows
    suspend fun toggleFollow(userId: String, targetUserId: String): Resource<Boolean>
    ...
    suspend fun hideContent(userId: String, contentId: String): Resource<Unit>
    suspend fun getHiddenContent(userId: String): Resource<List<String>>
    
    // Shares
    suspend fun recordShare(userId: String, targetId: String): Resource<Unit>
}
