...
enum class ContentDisciplineType(
    val code: String,
    val titleArabic: String,
) {
...
enum class TaxonomyVerificationStatus(
    val code: String,
    val titleArabic: String,
) {
...
enum class TaxonomyRightsStatus(
    val code: String,
    val titleArabic: String,
    val isPublicDomainOrLicensed: Boolean,
) {
