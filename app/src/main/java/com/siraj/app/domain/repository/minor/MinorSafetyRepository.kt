...
interface MinorSafetyRepository {
    ...
    suspend fun setUserAgeBracket(userId: String, bracket: UserAgeBracket, guardianEmail: String?): Resource<MinorSafetyPolicy>
    suspend fun requestParentalConsent(childUserId: String, guardianEmail: String, guardianName: String): Resource<ParentalConsentRecord>
    suspend fun verifyParentalConsent(consentId: String, verificationCode: String): Resource<ParentalConsentRecord>
    ...
    fun evaluateEducationalContent(contentId: String, title: String, textSnippet: String): EducationalContentSafetyCheck
}
