...
class FirebaseFlashPublishingRepositoryImpl : FlashPublishingRepository {
    ...
    private fun logTransition(flashId: String, from: FlashPublishingState?, to: FlashPublishingState, actionBy: String, reason: String? = null) {
    ...
    override suspend fun submitForReview(flashId: String, userId: String): Resource<Flash> {
        delay(500)
        val flash = flashesStore[flashId] ?: return Resource.Error("الومضة غير موجودة")
    ...
    override suspend fun publishFlash(flashId: String, userId: String): Resource<Flash> {
        delay(500)
        val flash = flashesStore[flashId] ?: return Resource.Error("الومضة غير موجودة")
    ...
    override suspend fun schedulePublish(flashId: String, userId: String, timestamp: Long): Resource<Flash> {
        delay(500)
        val flash = flashesStore[flashId] ?: return Resource.Error("الومضة غير موجودة")
    ...
    override suspend fun suspendFlash(flashId: String, userId: String, reason: String): Resource<Flash> {
        delay(500)
        val flash = flashesStore[flashId] ?: return Resource.Error("الومضة غير موجودة")
    ...
    override suspend fun revertToDraft(flashId: String, userId: String): Resource<Flash> {
        delay(400)
        val flash = flashesStore[flashId] ?: return Resource.Error("الومضة غير موجودة")
    ...
    override suspend fun approveFlash(flashId: String, reviewerId: String): Resource<Flash> {
        delay(500)
        val flash = flashesStore[flashId] ?: return Resource.Error("الومضة غير موجودة")
    ...
    override suspend fun rejectFlash(flashId: String, reviewerId: String, reason: String): Resource<Flash> {
        delay(500)
        val flash = flashesStore[flashId] ?: return Resource.Error("الومضة غير موجودة")
