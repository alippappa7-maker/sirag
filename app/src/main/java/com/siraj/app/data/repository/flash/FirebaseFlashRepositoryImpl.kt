...
class FirebaseFlashRepositoryImpl : FlashRepository {
    ...
    private val mockFlashes = listOf(
        Flash(
            id = "flash_1",
            creatorId = "creator_1",
            ...
            category = "موعظة",
            sourceInfo = FlashSourceInfo("src_1", "رياض الصالحين - باب الصبر", FlashPublishingState.APPROVED, System.currentTimeMillis() - 86400000),
    ...
    override suspend fun getFlashesFeed(pageToken: String?, limit: Int): Resource<FlashesFeedResult> {
    ...
    override suspend fun reportFlash(flashId: String, reason: String): Resource<Unit> {
        delay(500)
