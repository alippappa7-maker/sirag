...
class QuranRepositoryImpl(
        ...
        try {
            ...
            val ayahs =
                response.verses.map { apiVerse ->
                    ...
                    val translation =
                        apiVerse.translations?.firstOrNull()?.let {
                            AyahTranslation(
                                text = it.text,
                    ...
                    val tafsir =
                        apiVerse.tafsirs?.firstOrNull()?.let {
                            AyahTafsir(
                                text = it.text,
    ...
    override fun getBookmarkedVerseKeys(): Flow<List<String>> = dao.getAllBookmarks().map { list -> list.map { it.verseKey } }
}
