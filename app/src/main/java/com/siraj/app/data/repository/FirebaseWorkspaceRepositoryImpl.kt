...
class FirebaseWorkspaceRepositoryImpl(
    ...
    override fun getUserWorkspaces(userId: String): Flow<Resource<List<Workspace>>> =
        callbackFlow {
    ...
    override fun getWorkspaceMembers(workspaceId: String): Flow<Resource<List<WorkspaceMember>>> =
        callbackFlow {
            trySend(Resource.Loading)
            val registration =
                membersCol
    ...
    override fun getWorkspaceInvitations(workspaceId: String): Flow<Resource<List<WorkspaceInvitation>>> =
        callbackFlow {
            trySend(Resource.Loading)
            val registration =
                invitationsCol
    ...
    override fun getUserInvitations(email: String): Flow<Resource<List<WorkspaceInvitation>>> =
        callbackFlow {
            trySend(Resource.Loading)
            val registration =
                invitationsCol
    ...
    override suspend fun leaveWorkspace(
        workspaceId: String,
        userId: String,
    ): Resource<Unit> = removeMember(workspaceId, userId)
