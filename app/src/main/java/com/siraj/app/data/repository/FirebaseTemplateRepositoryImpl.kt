            ...
            val defaultTemplates =
                listOf(
                    ContentTemplate(
                        id = "tpl_aya_1",
                        name = "آية وتدبر",
                        description = "عرض آية قرآنية مع تدبر أو تفسير مبسط",
                        targetAudience = "عام",
                        recommendedDuration = "قصير (أقل من دقيقة)",
                        sceneStyle = "موشن جرافيك",
                        hasQuran = true,
                        requiredFields = listOf("الآية", "التدبر"),
                    ),
                    ContentTemplate(
                        id = "tpl_hadith_1",
                        name = "حديث موثق",
                        description = "نشر حديث نبوي مع شرحه وتخريجه",
                        targetAudience = "عام",
                        recommendedDuration = "قصير (أقل من دقيقة)",
                        sceneStyle = "موشن جرافيك",
                        hasHadith = true,
                        requiredFields = listOf("نص الحديث", "التخريج"),
                    ),
                    ContentTemplate(
                        id = "tpl_story_1",
                        name = "قصة من السيرة",
                        description = "سرد قصة قصيرة من سيرة النبي أو الصحابة",
                        targetAudience = "شباب",
                        recommendedDuration = "متوسط (1-3 دقائق)",
                        sceneStyle = "وايت بورد",
                        requiredFields = listOf("القصة", "العبرة المستفادة"),
                    ),
                    ContentTemplate(
                        id = "tpl_dua_1",
                        name = "دعاء موثق",
                        description = "تصميم روحاني لدعاء من الكتاب أو السنة",
                        targetAudience = "عام",
                        recommendedDuration = "قصير (أقل من دقيقة)",
                        sceneStyle = "تصوير حي",
                        hasQuran = false,
                        hasHadith = true,
                        requiredFields = listOf("نص الدعاء"),
                    ),
                    ContentTemplate(
                        id = "tpl_reminder_1",
                        name = "تذكير قصير",
                        description = "خاطرة سريعة أو تذكير بعمل صالح",
                        targetAudience = "عام",
                        recommendedDuration = "قصير (أقل من دقيقة)",
                        sceneStyle = "موشن جرافيك",
                        requiredFields = listOf("نص التذكير"),
                    ),
                    ContentTemplate(
                        id = "tpl_qa_1",
                        name = "سؤال وجواب",
                        description = "طرح سؤال شرعي أو فقهي والإجابة عليه",
                        targetAudience = "عام",
                        recommendedDuration = "متوسط (1-3 دقائق)",
                        sceneStyle = "موشن جرافيك",
                        hasFatwa = true,
                        requiredFields = listOf("السؤال", "الإجابة"),
                    ),
                    ContentTemplate(
                        id = "tpl_summary_1",
                        name = "ملخص درس",
                        description = "تلخيص لأهم النقاط من درس أو خطبة",
                        targetAudience = "أكاديمي/متخصص",
                        recommendedDuration = "طويل (أكثر من 3 دقائق)",
                        sceneStyle = "موشن جرافيك",
                        requiredFields = listOf("عنوان الدرس", "النقاط الرئيسية"),
                    ),
                    ContentTemplate(
                        id = "tpl_kids_1",
                        name = "درس للأطفال",
                        description = "محتوى مبسط ومرح موجه للأطفال",
                        targetAudience = "أطفال",
                        recommendedDuration = "متوسط (1-3 دقائق)",
                        sceneStyle = "موشن جرافيك",
                        requiredFields = listOf("القيم المستهدفة"),
                    ),
                    ContentTemplate(
                        id = "tpl_mosque_1",
                        name = "إعلان مسجد أو مركز",
                        description = "إعلان عن فعالية أو دورة في مسجد",
                        targetAudience = "عام",
                        recommendedDuration = "قصير (أقل من دقيقة)",
                        sceneStyle = "نصي فقط",
                        requiredFields = listOf("الفعالية", "الزمان", "المكان"),
                    ),
                    ContentTemplate(
                        id = "tpl_scholar_1",
                        name = "بطاقة كتاب أو عالم",
                        description = "تعريف بكتاب إسلامي أو نبذة عن عالم",
                        targetAudience = "أكاديمي/متخصص",
                        recommendedDuration = "قصير (أقل من دقيقة)",
                        sceneStyle = "موشن جرافيك",
                        requiredFields = listOf("اسم الكتاب/العالم", "النبذة"),
                    ),
                )
