...
object AccessibilitySemantics {
     ...
     */
    fun Modifier.sirajTouchTarget(minSize: Dp = 48.dp): Modifier =
        this
     ...
     */
    fun Modifier.sirajHeading(): Modifier =
        this.semantics {
            heading()
        }
     ...
     */
    fun Modifier.sirajLiveRegion(isAssertive: Boolean = false): Modifier =
        this.semantics {
