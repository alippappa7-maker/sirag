...
class UgcModerationTest {
    ...
    @Test
    fun testPreUploadScan_detectsSpamAndRestricts() =
        runBlocking {
    ...
    @Test
    fun testPreUploadScan_detectsHarmfulContentAndRejects() =
        runBlocking {
    ...
    @Test
    fun testPreUploadScan_detectsReligiousContentAndRoutesToReview() =
        runBlocking {
    ...
    @Test
    fun testPreUploadScan_cleanContentApproves() =
        runBlocking {
    ...
    @Test
    fun testTermsOfServiceConsent_recordingAndCheck() =
        runBlocking {
    ...
    @Test
    fun testModeratorActionOnUgc_limitsAndLogsAudit() =
        runBlocking {
            ...
            val actionRes =
                repository.takeModeratorActionOnUgc(
                    ugcId = firstItem.id,
    ...
    @Test
    fun testAppealsWorkflow_submitAndApproveRestoresContent() =
        runBlocking {
    ...
    @Test
    fun testUserBlockingAndSuspension() =
        runBlocking {
