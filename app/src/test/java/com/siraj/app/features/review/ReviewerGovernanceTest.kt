...
class ReviewerGovernanceTest {
    ...
    fun setUp() {
        ...
        activeFiqhReviewer = ReviewerProfile(
            id = "rev_fiqh_01",
        ...
        pendingReviewer = activeFiqhReviewer.copy(
            id = "rev_pending_01",
            status = ReviewerStatus.PENDING_VERIFICATION,
            verifiedByOwnerId = null
        )

        suspendedReviewer = activeFiqhReviewer.copy(
            id = "rev_suspended_01",
    ...
    fun testReviewerMustBeActiveAndVerifiedByOwner() {
        val pendingResult = ReviewerGovernanceEngine.validateReviewerEligibility(
        ...
        val suspendedResult = ReviewerGovernanceEngine.validateReviewerEligibility(
        ...
        val activeResult = ReviewerGovernanceEngine.validateReviewerEligibility(
    ...
    fun testDomainScopeRestriction() {
        ...
        val hadithResult = ReviewerGovernanceEngine.validateReviewerEligibility(
            reviewer = activeFiqhReviewer,
        ...
        val fiqhResult = ReviewerGovernanceEngine.validateReviewerEligibility(
            reviewer = activeFiqhReviewer,
            domain = ReviewerDomain.FIQH,
            riskLevel = RiskLevel.LOW,
            criticalTopic = CriticalTopic.NONE
    ...
    fun testExcludedCriticalTopics() {
        ...
        val takfierResult = ReviewerGovernanceEngine.validateReviewerEligibility(
            reviewer = activeFiqhReviewer,
            domain = ReviewerDomain.FIQH,
        ...
        val fatwaResult = ReviewerGovernanceEngine.validateReviewerEligibility(
            reviewer = activeFiqhReviewer,
            domain = ReviewerDomain.FIQH,
    ...
    fun testConflictOfInterest_CreatorCannotReviewOwnContent() {
        val conflictResult = ReviewerGovernanceEngine.checkConflictOfInterest(
    ...
    fun testDecisionImmutabilityAndVersionTracking() {
        ...
        val decision1 = ReviewerGovernanceEngine.createImmutableDecision(
        ...
        val decision2 = ReviewerGovernanceEngine.createImmutableDecision(
