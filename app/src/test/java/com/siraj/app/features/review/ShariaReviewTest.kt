...
class ShariaReviewTest {
    ...
    @Test
    fun testGetReviewQueue_ReturnsDefaultPreSeededItems() = runTest {
    ...
    @Test
    fun testFilterQueue_ByRiskLevel() = runTest {
    ...
    fun testRule_CreatorCannotReviewOwnContent() = runTest {
        ...
        val approveResult = repository.approveItem(
            itemId = item.id,
            reviewerId = creatorId,
            reviewerName = "صانع المحتوى",
            reason = "موافق"
    ...
    @Test
    fun testStandardApproval_LowRiskContent() = runTest {
    ...
    @Test
    fun testCriticalTopic_RequiresDualApproval() = runTest {
        ...
        val secondReviewResult = repository.submitSecondReviewDecision(
            itemId = itemId,
    ...
    @Test
    fun testRequestChanges_UpdatesStatusAndLogs() = runTest {
        val itemId = "review_item_001"
        val reviewerId = "rev_reviewer_1"
        val reviewerName = "الشيخ أحمد"

        val res = repository.requestChanges(
            itemId = itemId,
            reviewerId = reviewerId,
            reviewerName = reviewerName,
    ...
    @Test
    fun testRule_ModifyingApprovedContent_ResetsToPendingReview() = runTest {
        ...
        val modifyResult = repository.notifyContentModified(
            itemId = "review_item_001",
    ...
    @Test
    fun testInternalNotesAndAuditLogs() = runTest {
        val itemId = "review_item_001"
        val addNoteResult = repository.addInternalNote(
            itemId = itemId,
